...
public class StreamsDemo {
    public static void main(String[] args) {
        ...
        warehouse2.setProducts(Arrays.asList(new Product("Boots", 49.99, 15200), new Product("HP Laptop", 2599.99, 876)));
        warehouse3.setProducts(Arrays.asList(new Product("SSD", 239.99, 900), new Product("Sony PlayStation", 2009.99, 1001)));
